...
def main():
    ...
    print(f"--- Training Joint Sequence IDL on {feature_dim}-D Energy Dataset ---")
    model.train()
    ...
    np.save(os.path.join(args.save_dir, 'idl_fake_energy.npy'), fake_data)
