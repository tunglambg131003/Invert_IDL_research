...
def main():
    ...
    print(f"--- Training Joint Sequence IDL on {feature_dim}-D Stock Dataset ---")
    model.train()
    ...
    np.save(os.path.join(args.save_dir, 'idl_fake_stock.npy'), fake_data)
