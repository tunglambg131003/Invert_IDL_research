...
def main():
    ...
    print(f"--- Training Joint Sequence IDL on {feature_dim}-D Stocks Dataset ---")
    model.train()
    ...
    np.save(os.path.join(args.save_dir, 'idl_fake_stocks.npy'), fake_data)
